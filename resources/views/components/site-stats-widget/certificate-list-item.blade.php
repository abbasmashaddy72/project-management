<div class="flex items-center justify-between">
    ...
    @elseif($site->sslCertificateCheck->status === \App\Enums\SslCertificateStatus::NOT_YET_CHECKED)
        <span class="text-gray-500">---</span>
    @elseif($site->down_for_maintenance_at)
        <span class="text-gray-500">---</span>
    @elseif($site->sslCertificateCheck->status === \App\Enums\SslCertificateStatus::VALID)
